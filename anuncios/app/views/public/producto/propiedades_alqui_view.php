<div class='container'>
<h5 style='font-size:1.4em;' class='left-align'>Propiedades en Alquiler</h5>
    <div class='row'>
                    ...
                    <div class='purple darken-3'>
                        <a style='color:white; height:80px;' href='pagina.php'>
                            <div class='col s7' id='previnfo_vehi'>
                                ...
                                <div class='row' id='name_dir_style' style='padding:0; margin:0; font-size:0.8em'>Colonia Flores AV. MF</div>
                            </div>
                            <div class=''>
