            ...
            <div style=' width:100%' class=''>
                <div class='col s12 m6 l5'>
                    <div style='margin-top:8px;' class='row'>
                        ...
                        <div id='img_cont_detail'>
                            <img width='100%' height='320px' src='../web/img/vehiculos/sedan_bmw_hd.jpg'>
                        ...
                        <a class='botom_img_static_c_p' >
                            ...
                            <div class=''>
                                <div class='row' style='text-align:center; font-size:1.2em; padding-top:6px;'>$13,000.00</div>
                            </div>
                ...
                <div class='col s12 m6 l4'>
                    ...
                    <div class='col s6'>   <p class='title_2'>X3 Letter</p></div>
                        ...
                        <div class='col s6'>   <p class='title_2'>1.8</p></div>
                            ...
                            <div class='col s6'> <p class='title_2'>No</p></div>
                            </div>
