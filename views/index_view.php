<main style="margin-left:56px">
   ...
   <div id="main_publico" class="row">
        <div class="col l5 hide-on-med-and-down" id="container_info_left">
             ...
             <div  class="info_block_left_logo">
                    <img id="large_logo_slider" src="public/img/logo/logo_large.png" alt="Seguros Familiares">
                </div>
            ...
            <div style="margin-top:24vh;" class="hide-on-med-and-down" id="contactanos_superior">
                ...
                <a id="wha_btn" href="whatsapp://send/?phone=50378633433&text=Me%20Gustaria%20obtener%20una%20cotizacion%20sobre%20los%20seguros%20que%20ofrecen." class="lateral_btn_style_bigs">
                    <img class="lateral_icons show-on-small" src="public/img/icon/wha_icon.png" alt="whatsapp">
                </a>
                
                  <a href="https://www.instagram.com/" class="lateral_btn_style_bigs">
                    <img class="lateral_icons" src="public/img/icon/insta_icon.png" alt="facebook">
                </a>
                ...
                <div  class="info_block_2">
                    ...
                    <div class="row" >
                        <div onclick="seguro_frm=1; abrir_form();"  id="contenedor_de_seguro"  class="col s12 m6" onmouseover="seg=1; change_etiquete(); " onmouseout="seg=1; change_etiquete_back();">
                            <div class="icon_container_1"><img src="public/img/icon/seg_medico.png" class="seguro_ico_1"></div>
                        ...
                        <div onclick="seguro_frm=2; abrir_form();"  id="contenedor_de_seguro"  class="col s12 m6" onmouseover=" seg=2; change_etiquete();" onmouseout="seg=2; change_etiquete_back();">
                            <div class="icon_container_2"><img src="public/img/icon/seg_vida.png" class="seguro_ico_2"></div>
                            <div class="info_seguro_prev">
                        ...
                        <div  onclick="seguro_frm=3; abrir_form();" id="contenedor_de_seguro"  class="col s12 m6" onmouseover="seg=3; change_etiquete();" onmouseout="seg=3; change_etiquete_back();">
                            <div class="icon_container_3"><img src="public/img/icon/seg_incendio.png" class="seguro_ico_3"></div>
                            <div class="info_seguro_prev">
                         ...
                         <div  onclick="seguro_frm=4; abrir_form();" id="contenedor_de_seguro"  class="col s12 m6" onmouseover="seg=4; change_etiquete();" onmouseout="seg=4; change_etiquete_back();">
                            <div class="icon_container_4"><img src="public/img/icon/seg_auto.png" class="seguro_ico_4"></div>
                            <div class="info_seguro_prev">
   ...
   <div id="main_publico_forms" class="row"> 
        ...
        <div class="col s12 m7 hide-on-small-only">
            <img id="large_logo_slider_frm" src="public/img/logo/logo_large.png" alt="Seguros Familiares">
        </div>
