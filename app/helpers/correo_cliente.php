    ...
    <h1 style='	color:rgb(0, 93, 180);
        ...
        <div class='row' style='margin-bottom:120px; height: 160px;border-top: 1px solid rgba(128, 128, 128, 0.377);'>
            <div style='float:left; width: 80%; '>
                ...
                font-weight: 50;
                text-align:center; margin-top: 40px; padding-left: 5%; padding-right: 5%;'>
                    El cliente con nombre $nombres $apellidos hizo una cotización de $seguro y la cantidad de pagos es de $cantidad_pagos, <br>
                    su fecha de nacimiento es $fecha_nacimiento, su correo electrónico es $correo, su número de telefono $telefono <br>
