...
class Solicitudes_procesadas extends Validator
{
	...
	public function getDiasxEmpleado()
	{
		$sql = 'SELECT csd.PK_id_cantidad_solicitud_dias, csd.lunes, csd.martes, csd.miercoles, csd.jueves, csd.viernes, csd.sabado, csd.domingo, csd.cant_lunes, csd.cant_martes, csd.cant_miercoles, csd.cant_jueves, csd.cant_viernes, csd.cant_sabado, csd.cant_domingo, csd.cant_castigo_lunes, csd.cant_castigo_martes, csd.cant_castigo_miercoles, csd.cant_castigo_jueves, csd.cant_castigo_viernes, csd.cant_castigo_sabado, csd.cant_castigo_domingo, csd.fecha_castigo_lunes, csd.fecha_castigo_martes, csd.fecha_castigo_miercoles, csd.fecha_castigo_jueves, csd.fecha_castigo_viernes, csd.fecha_castigo_sabado, csd.fecha_castigo_domingo, es.estado
